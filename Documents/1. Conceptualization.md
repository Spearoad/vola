...
| :--- | :--- | :--- | :--- |
| 2026-03-14 | 1.00 | Conceptualization 문서 초안 작성 |  |
...
* **API 호출 제한:** 외부 증권사 API의 제한된 요청 수로 인해, 앱이 직접 데이터를 요청할 경우 유저 수에 비례하여 트래픽이 기하급수적으로 증가하므로, 중앙 서버가 1분 단위로 데이터를 일괄 수집하고 분배하는 구조로 설계하여 해결해야 한다.
